...
美股港股全栈数据工具包 — 7 层架构 · 17 个端点 · 5 个数据源 · 全部零鉴权 · 仅依赖 requests
...
├── 基本面    东财datacenter三表+GMAININDICATOR + Yahoo 23模块 + SEC XBRL  财报+关键指标+估值+机构持仓
...
Full-stack data toolkit for US & HK stock markets — 7-layer architecture · 17 endpoints · 5 data sources · zero API keys · only depends on requests
...
```
US & HK Stock Full-Stack Data · 7-Layer Architecture · V1.0
│
...
├── Fundamentals   Eastmoney datacenter+GMAININDICATOR + Yahoo 23 modules + SEC XBRL  Statements+Key Metrics+Valuation+Holdings
